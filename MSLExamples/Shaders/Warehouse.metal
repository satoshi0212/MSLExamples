...
//
//    rh = sdRhombus((p+float2(0.1,0.06))*Rot(radians(-65.0)),size);
...
//}
//
//float3 jpTraditionalTex1(float2 p, float3 col, float3 rhcol) {
//    float2 pref = p;
//
//    float scale = 1.5;
//    p*=scale;
...
//}
//
//float3 textile2(float2 p, float3 col, float3 bcol) {
//    float bsize = 0.15;
//    p *= Rot(radians(45.0));
...
//}
//
//float3 jpTraditionalTex2(float2 p, float3 col, float3 bcol) {
//    float2 pref = p;
//
//    float scale = 1.5;
//    p*=scale;
...
//}
//
//float3 jpTraditionalTex3(float2 p, float3 col, float3 ccol) {
//    float2 pref = p;
//
...
//}
//
//float3 textile4(float2 p, float3 col, float3 ccol) {
//    float r = 0.16;
//
...
//    col = mix(col, float3(1.0),S(c,0.0));
...
//}
//
//float3 jpTraditionalTex4(float2 p, float3 col, float3 ccol) {
//    float2 pref = p;
//
//    p.x = mod(p.x,0.4)-(0.2);
...
//}
//
//float3 textile5(float2 p, float3 col, float3 ccol) {
//    float2 pref = p;
//    p.y = abs(p.y);
//    p.y -= 0.1;
//    float c = sdEllipse(p,float2(0.04,0.06));
//    float c2 = sdEllipse((p-float2(-0.02,-0.01))*Rot(radians(-10.0)),float2(0.04,0.05));
//    float c3 = sdEllipse((p-float2(0.02,-0.01))*Rot(radians(10.0)),float2(0.04,0.05));
//    c = min(c, min(c2,c3));
...
//    c2 = sdEllipse((p-float2(-0.015,-0.015))*Rot(radians(15.0)),float2(0.07,0.04));
//    c3 = sdEllipse((p-float2(-0.015,0.015))*Rot(radians(-15.0)),float2(0.07,0.04));
...
//}
//
//float3 jpTraditionalTex5(float2 p, float3 col, float3 ccol) {
//    float2 pref = p;
//
//    float scale = 1.5;
//    p*=scale;
...
//}
//
//float3 textile6(float2 p, float3 col, float3 ccol) {
//    float n = 5.0;
//    float deg = 360.0/n;
...
//}
//
//float3 textile6RepeatBg(float2 p, float3 col, float3 ccol) {
//    float scale = 1.5;
//    p*=scale;
...
//}
//
//float3 jpTraditionalTex6(float2 p, float3 col, float3 ccol) {
//    float2 pref = p;
//
...
//}
//
//float3 textile7(float2 p, float3 col, float3 ccol) {
//    float n = 5.0;
//    float deg = 360.0/n;
//    float startRad = radians(180.0);
//    float ld = 1.0;
...
//}
//
//float3 jpTraditionalTex7(float2 p, float3 col, float3 ccol) {
//    float2 pref = p;
//    float scale = 1.5;
//    p*=scale;
//
...
//}
//
//float3 textile8(float2 p, float3 col, float3 ccol){
//    float b = sdBox(p*Rot(radians(45.0)),float2(0.05))-0.05;
//    b = max(-(length(p)-0.03),b);
//    col = mix(col, ccol,S(b,0.0));
//    return col;
//}
//
//float3 jpTraditionalTex8(float2 p, float3 col, float3 ccol) {
//    float2 pref = p;
//    p = mod(p,0.3)-0.15;
...
//}
//
//float3 textile9(float2 p, float3 col, float3 ccol){
...
//}
//
//float3 textile9RepeatBg(float2 p, float3 col, float3 ccol) {
//    float2 pref = p;
...
//}
//
//float3 jpTraditionalTex9(float2 p, float3 col, float3 ccol) {
//    float2 pref = p;
